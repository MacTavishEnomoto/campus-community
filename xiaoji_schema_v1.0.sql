...
CREATE TABLE xj_posts (
  ...
  school_id      BIGINT UNSIGNED NOT NULL COMMENT '分片键之一(校内圈)',
  ...
  status         TINYINT      NOT NULL DEFAULT 1 COMMENT '0正常 1待审 2下架 3删除',
...
CREATE TABLE xj_conversations (
  ...
  user_a      BIGINT UNSIGNED NOT NULL DEFAULT 0 COMMENT '单聊双方(小id在前)',
  user_b      BIGINT UNSIGNED NOT NULL DEFAULT 0,
...
('credit_min_publish',       '40',    '发布商品信用分门槛'),
